...
# Name for the final executable. Many intermediate files have names
# derived from this name. The file that will be uploaded to the 
# board has this name, followed by ".hex".
NAME=usb_lcd
...
WIRE_DIR=$(ARDUINO_DIR)/hardware/arduino/avr/libraries/Wire/src
WIRE_UTIL_DIR=$(ARDUINO_DIR)/hardware/arduino/avr/libraries/Wire/src/utility
...
PROG_OBJS=usb_lcd.o lcd8574arduino.o Wire.o twi.o
...
INCLUDES=-I $(INCLUDE) -I $(WIRE_DIR) -I $(WIRE_UTIL_DIR)
...
INCLUDES=-I $(VARIANT_INCLUDE) -I $(INCLUDE) -I $(WIRE_DIR)
